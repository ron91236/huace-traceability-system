...
function renderScreenData(data: any) {
  ...
  if (charts[0]) {
    charts[0].setOption({
      ...
      xAxis: { type: 'category', data: provinceData.map((d: any) => d.province), axisLabel: { color: axisColor, fontSize: 10, rotate: 30 }, axisLine: { lineStyle: { color: splitColor } } },
  ...
  if (charts[1]) {
    charts[1].setOption({
      ...
      yAxis: { type: 'value', axisLabel: { color: axisColor }, splitLine: { lineStyle: { color: splitColor } } },
      series: [{ type: 'line', data: trendData.map((d: any) => d.count), smooth: true, areaStyle: { color: 'rgba(24,144,255,0.15)' }, lineStyle: { color: '#1890ff' }, itemStyle: { color: '#1890ff' } }],
  ...
  if (charts[2]) {
    charts[2].setOption({
      ...
      yAxis: { type: 'category', data: cityData.map((d: any) => d.city).reverse(), axisLabel: { color: axisColor, fontSize: 10 }, axisLine: { lineStyle: { color: splitColor } } },
  ...
  if (charts[4]) {
    charts[4].setOption({
      tooltip: { trigger: 'axis' },
      xAxis: { type: 'category', data: labelData.map((d: any) => d.month), axisLabel: { color: axisColor, fontSize: 10 }, axisLine: { lineStyle: { color: splitColor } } },
      yAxis: { type: 'value', axisLabel: { color: axisColor }, splitLine: { lineStyle: { color: splitColor } } },
      series: [{ type: 'line', data: labelData.map((d: any) => d.count), smooth: true, areaStyle: { color: 'rgba(54,207,201,0.15)' }, lineStyle: { color: '#36cfc9' }, itemStyle: { color: '#36cfc9' } }],
      grid: { left: 40, right: 10, top: 10, bottom: 30 },
    })
  }
